...
public class UserDrawMapReduce {
	...
	public static class MyMap extends
		...
		public void map(LongWritable key, Text value, Context context)
			...
			//key
			String uiqkey = dataArray[Integer.parseInt(config.MDN)] + dataArray[Integer.parseInt(config.appID)]; // MDN + appID
	...
	public static void main(String[] args) throws Exception {
		...
		FileInputFormat.addInputPath(job1, new Path("file:///d:/scala/draw/data"));// 输入路径
		FileOutputFormat.setOutputPath(job1, new Path("file:///d:/scala/draw/data/out"));// 输出路径
		...
		System.out.println("job1执行成功！！！");
			if (state1) {
				...
				FileInputFormat.addInputPath(job2, new Path("file:///d:/scala/draw/data/out"));// 输入路径
				FileOutputFormat.setOutputPath(job2, new Path("file:///d:/scala/draw/data/out2"));// 输出路径
